        ...
        >
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
            <div className="space-y-4">
              ...
              <p className="text-white/80 text-lg font-medium max-w-xl">A comprehensive 30-objective circuit spanning all linguistic domains. The definitive test of your proficiency.</p>
            </div>
               ...
               >
                 ...
                 <div className="relative z-10">
                    ...
                    <div className="flex items-center gap-2">
                       <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">30 Objectives</span>
    ...
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center text-center space-y-8">
        ...
        <div className="space-y-3">
           ...
           <p className="text-slate-400 text-lg font-medium">Calibrating 30 high-fidelity objectives for <br/><span className="text-primary-400 font-bold">{selectedTopic}</span></p>
        </div>
      </div>
    );
  }
