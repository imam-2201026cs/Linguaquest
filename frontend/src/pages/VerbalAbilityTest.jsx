      ...
      <div className="max-w-4xl mx-auto pb-20 animate-slide-up">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-slate-400">Master English proficiency with 30-question targeted practice</p>
          </div>
        </div>
        ...
        >
          ...
          <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
              ...
              <p className="text-white/80 max-w-md">A comprehensive 30-question mixture of all topics to test your overall English proficiency.</p>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          {TOPICS.map((topic, i) => (
            ...
            >
              ...
              <p className="text-xs text-slate-500">30 Questions • Advanced</p>
            </button>
          ))}
        </div>
      </div>
  ...
  if (stage === 1) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center text-center">
        ...
        <p className="text-slate-400">Our AI is hand-picking 30 high-quality questions for <br/><strong className="text-primary-400">{selectedTopic}</strong>...</p>
      </div>
    );
  }
